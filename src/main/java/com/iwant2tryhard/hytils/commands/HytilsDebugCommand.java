        ...
        if (Hytils.instance.getConfig().devMode) {
            if (args.length > 0) {
                if (args[0].equalsIgnoreCase("state")) {
                    ...
                    Hytils.instance.getConfig().devMode = false;
                    Utils.sendMessage(new ChatComponentText(EnumChatFormatting.GOLD + "[Hytils] " + EnumChatFormatting.GREEN + "Debug Mode disabled!"));
            ...
            Utils.sendMessage(new ChatComponentText(EnumChatFormatting.GOLD + "[Hytils] " + EnumChatFormatting.RED + "This command is disabled!"));
        }
    }
